"""
Django settings for testapp_40817 project.
...
ROOT_URLCONF = 'testapp_40817.urls'
...
WSGI_APPLICATION = 'testapp_40817.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "testapp_40817 API",
    "DESCRIPTION": "API documentation for testapp_40817 App",
    "VERSION": "v1",
}
